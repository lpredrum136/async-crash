...
resolvedProm.then(() => {
  ...
  throw new Error('oh no!');
            ...
            }, error => {//error here is the thing in reject(the thing)
...
rejectedProm.then(() => 99, () => 42)// onRejected returns 42 which is wrapped in a resolving Promise
...
resolvedProm.then(() => {
  ...
  throw new Error('oh no!');
            ...
            .then((value) => {
              console.log(`I am always called even if the prior then's (the first then) promise rejects`);
